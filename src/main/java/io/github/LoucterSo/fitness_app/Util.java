...
public class Util {
    ...
    public static Integer calculateDailyCalorieIntake(User user) {
        int calorieNorm;
        if (user.isMan()) {
            calorieNorm = (int) (Math.round(66.5 + (13.75 * user.getWeightInKg()) + (5.003 * user.getHeightInCm()) - (6.755 * user.getAge())));
        } else {
            calorieNorm = (int) (Math.round(655 + (9.563 * user.getWeightInKg()) + (1.850 * user.getHeightInCm()) - (4.676 * user.getAge())));
        }
